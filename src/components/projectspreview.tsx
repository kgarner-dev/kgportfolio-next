...
export function ProjectsPreview() {
    ...
    return (
        ...
        <div className="preview">
            ...
            <PreviewCard key={999} title={"More coming soon..."} tag={""} description={"Be on the lookout for more projects featured on this page."} date={""} thumbnail={"https://utfs.io/f/C3h9qu5XgJvHVbj5uQqW8bhg7kDjcYUI5le2ME3qfydFB04N"} cardSize={"small"} url={""} />
        </div>
    </section>
    );
}