...
interface Content { title: string, tag: string, description: string, year: string, thumbnail: string, cardSize: string, url:string }
    ...
    return (
        ...
        >
            <div className="grid grid-cols-2">
                ...
                <p className="text-white col-span-2 md:col-span-1 md:text-right">{ props.year }</p>
